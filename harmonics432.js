...
renderHarmonics = function renderHarmonicsWith432(people) {
  let html = '<tr><th>Person</th><th>Geometric fundamental</th><th>Day cycles</th><th>432 residue H</th><th>432-base harmonic</th><th>432 octave family</th><th>Legacy index</th><th>Legacy audio mapping</th><th>Closest returns</th></tr>';
  ...
  for (const person of people) {
    ...
    const base432Tone = h432 > 0 ? toneButtonHtml(h432) : '0 Hz / phase-zero';
    ...
    html += `<tr>
      ...
      <td>${Math.abs(person.dayArm)}</td>
      <td class="tone-list">${base432Tone}</td>
